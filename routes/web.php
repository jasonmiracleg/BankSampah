...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/jual/sampah', [GeneralController::class, 'sellingIndex'])->name('jual.sampah');
    Route::post('/jual', [SetorController::class, 'sell'])->name('penyetoran.jual');
    Route::post('/tarik', [SetorController::class, 'withdraw'])->name('penyetoran.tarik');
