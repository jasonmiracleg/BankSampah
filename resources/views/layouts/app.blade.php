...
<nav class="bg-green-500 border-gray-200 top-0 fixed z-50 w-full">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl text-white font-semibold whitespace-nowrap">Bank Sampah Management System</span>
        </a>
...
<footer class="bg-green-400 rounded-lg shadow m-4 dark:bg-gray-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a href="https://bsms.kevinchr.com/" class="hover:underline">Bank Sampah Management System™</a>. <br> All Rights Reserved.</span>
        <br>
        <br>
        <span class="text-sm text-white sm:text-center dark:text-gray-400">Created by <a href="https://kevinchr.com/" class="hover:underline">Kevin Christian</a> and <a href="#" class="hover:underline">Jason Miracle Gunawan</a>. <br> Hosted by <a href="https://kevinchr.com/" class="hover:underline">kevinchr.com</a></span>
